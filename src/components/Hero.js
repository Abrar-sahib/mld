...
import heroImg from "../images/truck.png";
          ...
          >
            ...
            >
              <h1 className="mb-5 md:text-5xl text-3xl font-bold text-blue-900">
                YOUR VIRTUAL DRIVING ASSISTANT
              </h1>
              <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">
                We specialize in best communication, comprehensive dispatching
                services designed to maximize fleet uptime, ensuring your
                vehicles remain operational and deliver efficient, reliable
